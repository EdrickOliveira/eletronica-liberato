...
void animationOne(image *cube, protocol *prot) {    //increase intensity
    //this function animates the cube by increasing the intensity of the LEDs.
    //it cycles through 16 different intensity levels, sending each level to the cube.
    int i = 0;
    char resp;
...
void animationTwo(image *cube, protocol *prot) {    //expand and contract
    //this function animates the cube by expanding and contracting the size of the cube.
    //it cycles through 9 different sizes, sending each size to the cube.
    int size = 0, j = 0;
    char resp;
    bool active = true, up = true;
